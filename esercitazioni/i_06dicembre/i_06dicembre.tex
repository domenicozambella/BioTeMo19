...
\bigskip\bigskip
\begin{question}
Una macchina è calibrata in modo da fare un taglio in un punto di coordinata $\mu_0=20$ (un unica dimensione). Se calibrata bene, la posizione del taglio è distribuita normalmente con media $\mu_0$ deviazione standard $\sigma=2$. 

Ogni tanto (per effetto delle vibrazioni) la macchina si sposta, va quindi fermata e ricalibrata. Idealmente vorremmo fermare la macchina quando la nuova media $\mu$ è a distanza maggiore di $3$ da $\mu_0$.
...
\item[2.] Dato tale valore critico al punto 1, qual'è la probabilità di non ricalibrare una macchina che necessita di essere ricalibrata?
