...
{\color{blue}
$f(x)$ cresce in $(-\sqrt{\py{latex(n[0])}}, 0)$ e $(\sqrt{\py{latex(n[0])}}, +\infty)$; 

$f(x)$ decresce in $(-\infty, -\sqrt{\py{latex(n[0])}})$ e $(0, \sqrt{\py{latex(n[0])}})$}
{\color{blue}
\hfill Risposta 1\kern0ex}

{\color{blue}
$f(x)$ ha massimo locale in $0$, minimi locali in $-\sqrt{\py{latex(n[0])}}$ e $\sqrt{\py{latex(n[0])}}$
\hfill Risposta 2\kern0ex}
...
{\color{blue}
$f(x)$ decresce in $\big(-\infty, -\dfrac{3}{2}\,\big)$
\hfill Risposta 2\kern0ex}
...
L'approssimazione lineare di $f(x)$ in 4 è data da $f'(4)(x-4) + f(4)$, 

essendo $f'(x) = \frac{1}{2\sqrt{x}}$ si ha
{\color{blue}
$\frac{1}{4} x + 1$ 
\hfill Risposta 1\kern0ex}
...
L'approssimazione lineare di $f(x)$ in 1 è data da $f'(1)(x-1) + f(1)$, essendo $f'(x) = \dfrac{1}{3\sqrt[3]{x^2}}$ si ha

{\color{blue}
$f(x)\simeq\dfrac{1}{3}x+\dfrac{2}{3}$ 
\hfill Risposta 1\kern0ex}

{\color{blue}
$\sqrt[3]{1.1} \cong 1.03$ e $\sqrt[3]{1.2} \cong 1.1$
\hfill Risposta 2\kern0ex}
