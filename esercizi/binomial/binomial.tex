...
$\displaystyle\Pr(X\ge\py{n_vittoria})\ =\ 1-\Pr( X\le\py{n_vittoria-1} )\ =\ ${\tt\color{blue}1-binom.cdf(\py{n_vittoria-1}, \py{n_partite}, \py{p}) = }{\tt\py{risultato} }
\end{answer}
\end{question}
...
$\Pr(X\ge\py{k})\ =\ 1-\Pr(X\le \py{k-1})$\quad =\ {\tt{\color{blue}  1 - binom.cdf( \py{k-1}, \py{n}, 1/\py{d} )} = \py{risposta}}{\color{blue}\hfill Risposta}
