...
\begin{question}
Si considerino le funzioni $f(x) = \cfrac{x + 1}{2x + 3}$ e $g(x) = \sqrt{3 - x}$
\begin{itemize}
...
Si consideri la funzione $f(x) = 1 + \log(\py{n1}x+\py{n2})$.
\begin{itemize}
\item[1.] Determinare dominio e immagine della funzione. 
...
{\color{blue} Dominio=$\displaystyle\bigg(\py{latex(-n2/n1)},\ +\infty\bigg)$\qquad Immagine=$\RR$\hfill Risposta 1\kern19ex}

{\color{blue}$\displaystyle x=\py{latex(-n1/(e*n2))}$\hfill Risposta 2\kern19ex}
...
\begin{itemize}
\item[1.] In quanti anni la concentrazione di anidride carbonica aumenterà di 5 ppm?
...
\item[2.] Quale sarà la concentrazione di anidride carbonica nel 2025?
\end{itemize}
\end{question}
...
\begin{itemize}
\item[1.] Qual è il periodo delle funzioni $\sin \left( x+3 \right)$ e $\cos \bigg( \cfrac{x+1}{3} \bigg)$?
\item[2.] Qual è il periodo della funzione $\tan \bigg( \cfrac{x}{2} \bigg)$?
\end{itemize}
\end{question}
